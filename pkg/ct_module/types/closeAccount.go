...
func NewCloseAccount(signedDenom []byte, address, denom string, currPendingBalanceLo, currPendingBalanceHi, currAvailableBalance *elgamal.Ciphertext) (*CloseAccount, error) {
